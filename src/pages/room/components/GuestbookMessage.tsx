...
export default function GuestbookMessage({
  ...
  return (
    <div className='guest-book-content @container w-full flex flex-col gap-2 2xl:gap-4 mt-3 mb-2 2xl:mb-3 3xl:mb-8 max-h-[400px] sm:max-h-80 min-h-[300px] sm:min-h-[400px]'>
      {/* 방명록 글 0개일 경우 */}
      {messages.length === 0 ? (
